...
public class MbLocalidad implements Serializable{
    ...
    private List<Localidad> listFilter;
    ...
    public Localidad getCurrent() {
        return current;
    }

    public void setCurrent(Localidad current) {
        this.current = current;
    }

    public List<Localidad> getListFilter() {
        return listFilter;
    }

    public void setListFilter(List<Localidad> listFilter) {
    ...
    **************************/
    ...
    public String cleanUp(){
        ...
        session.removeAttribute("mbLocalidad");
        ...
        if(!iniciado){
            ...
            while(enume.hasMoreElements()){
                ...
                if(s.substring(0, 2).equals("mb")){
                    if(!s.equals("mbLocalidad") && !s.equals("mbLogin")){
