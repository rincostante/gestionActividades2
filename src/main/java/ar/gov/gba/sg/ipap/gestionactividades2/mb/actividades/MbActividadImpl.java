...
public class MbActividadImpl implements Serializable{
    ...
    @EJB
    private EstadoActividadFacade estActFacade;
    @EJB
    ...
    private List<EstadoActividad> listEstAct;
    ...
    private int tipoList; //1=habilitadas | 2=finalizadas | 3=deshabilitadas 
    ...
    public List<EstadoActividad> getListEstAct() {
        return listEstAct;
    }

    public void setListEstAct(List<EstadoActividad> listEstAct) {
        this.listEstAct = listEstAct;
    }
    ...
    /**
     * Método para inicializar el listado de las Actividad Implementadas vencidos
     * @return acción para el listado de entidades
     */
