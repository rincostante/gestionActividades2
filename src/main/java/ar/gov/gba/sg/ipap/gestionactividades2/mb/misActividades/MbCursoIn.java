 ...
 * @author rincostante
 */
public class MbCursoIn implements Serializable{
    ...
    /**
     * Creates a new instance of MbCursoIn
     */
    public MbCursoIn() {
    }
    ...
    public List<ActividadImplementada> getListado() {
        if (listado == null){
            listado = getFacade().getHabilitadasXPart(referente);
        }
        return listado;
    }
        ...
        if(!iniciado){
            ...
            while(enume.hasMoreElements()){
                ...
                if(s.substring(0, 2).equals("mb")){
                    if(!s.equals("mbCursoIn") && !s.equals("mbLogin")){
   ...
   /*********************************************
    ...
    public String cleanUp(){
        HttpSession session = (HttpSession) FacesContext.getCurrentInstance()
                .getExternalContext().getSession(true);
        session.removeAttribute("mbCursoIn");
    ...
    public void verClases(){
        listClases = getFacade().getClasesXActPart(current, referente);
    ...
    *********************************************************************/
    ...
    public static class ActividadImplementadaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            MbCursoIn controller = (MbCursoIn) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "mbCursoIn");
