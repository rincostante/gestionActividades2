...
/**
 * Entidad paramétrica que indica el Estado de las Actividades implementadas
 * Se vincula a:
...
public class EstadoActividad implements Serializable {
    ...
    /**
     * Campo de texto que indica el nombre del Estado
     */
    ...
    public String toString() {
        return "ar.gov.gba.sg.ipap.gestionactividades.entities.actividades.EstadoActividad[ id=" + id + " ]";
    }
